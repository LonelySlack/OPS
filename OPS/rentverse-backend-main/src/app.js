...
// Import routes
const authRoutes = require('./routes/auth').router || require('./routes/auth'); // fallback for both export styles
...
// Rate limiting middleware (should be registered before routes)
const rateLimit = require('express-rate-limit');

// 1. Strict limit for login & MFA endpoints (prevent brute force)
...
// 2. General API rate limit (prevent abuse)
...
// Then, apply stricter limiter specifically to login endpoints.
// This will override the general limiter for these more sensitive routes.
...
const leasesRoutes = require('./routes/lease'); 
